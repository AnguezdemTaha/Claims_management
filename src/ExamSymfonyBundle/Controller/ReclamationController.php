...
use ExamSymfonyBundle\Entity\Reclamation;
...
class ReclamationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reclamations = $em->getRepository('ExamSymfonyBundle:Reclamation')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ExamSymfonyBundle\Form\ReclamationType', $reclamation);
    ...
    {
        $deleteForm = $this->createDeleteForm($reclamation);
        $editForm = $this->createForm('ExamSymfonyBundle\Form\ReclamationType', $reclamation);
